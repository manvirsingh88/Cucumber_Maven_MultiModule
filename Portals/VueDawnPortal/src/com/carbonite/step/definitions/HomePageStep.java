...
public class HomePageStep extends CustomeBase {

	private CustomeBase base;
	private HomePage homepage;

	public HomePageStep(CustomeBase base) {
		this.base = base;
	...
	public void verify_the_title_of_home_page(String titleOfPage) {
		...
		Assert.assertEquals(titleOfPage, HomePage.Localisation.PAGE_TITLE.get());
	}
	...
	public void verify_the_main_header_text_of_home_page(String mainHeaderText) {
		...
		Assert.assertEquals(mainHeaderText,HomePage.Localisation.MAIN_HEADER_TEXT.get());
	}
	...
	public void verify_the_sub_header_text_of_home_page(String subHeaderText) {
		...
		Assert.assertEquals(subHeaderText, HomePage.Localisation.SUB_HEADER_TEXT.get());
	}
