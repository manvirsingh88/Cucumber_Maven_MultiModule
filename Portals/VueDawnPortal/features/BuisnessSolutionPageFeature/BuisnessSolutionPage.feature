...
Feature: Verify Headers and subHeaders of Home Back Up
  ...
  Background: 
    ...
    Then User Click on Buisness Solution hyperlink

  Scenario: Title of Page
    Then Verify the title of Buisness Solution page ""

  Scenario: Main Header Text
    Then Verify the main Header Text of Buisness Solution page ""

  @debug
  Scenario: SubHeader Text
    Then Verify the Sub Header Text of Buisness Solution page ""
